...
```
AVG([State Average Loans Per Member]) - [Overall Average Loans Per Member]
```
...
1. Create a new calculated field
2. Name: **Loans Per Member (Aggregate Version)**
3. Formula:
...
This creates a unique key by combining Member ID and Loan Number, then divides by member count.

**When to Use Each Approach:**

- **INCLUDE**: Most flexible; adapts to view changes
- **FIXED**: When you want to lock to specific dimensions
- **Regular Aggregation**: When you want calculations that respond to filters normally
